...
export const Modules = () => {
  const crud = useCRUD('modules', moduleSchema);
    ...
    <div className="space-y-6">
      ...
      <Dialog open={crud.isDialogOpen} onOpenChange={crud.setIsDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>{crud.editingItem ? 'Edit Module' : 'Create Module'}</DialogTitle>
            <DialogDescription>
              {crud.editingItem ? 'Update module details' : 'Add a new module to the system'}
            </DialogDescription>
          </DialogHeader>
