    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-4">
        ...
        <Card className="border-l-4 border-l-emerald-500">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">{kpis.won}</div>
            <p className="text-xs text-gray-500 mt-1">Successful deals</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-red-500">
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-500 mt-1">Unsuccessful deals</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-purple-500">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">{formatCurrency(kpis.pipeline_value)}</div>
            <p className="text-xs text-gray-500 mt-1">Total expected revenue</p>
          </CardContent>
        </Card>
