...
export const Designations = () => {
  const crud = useCRUD('designations', designationSchema);
    ...
    <div className="space-y-6">
      ...
      <Dialog open={crud.isDialogOpen} onOpenChange={crud.setIsDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>{crud.editingItem ? 'Edit Designation' : 'Create Designation'}</DialogTitle>
            <DialogDescription>
              {crud.editingItem ? 'Update designation details' : 'Add a new designation to the system'}
            </DialogDescription>
          </DialogHeader>
